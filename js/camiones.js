    ...
    return `
      <div class="truck-card">
        ...
        <div class="truck-footer">
          <button class="btn-detail" onclick="openDetail('${escJs(c.id)}')">Ver detalle</button>
          ${currentUser.rol === 'cliente' || !currentUser.id
            ...
            : `<button class="btn-reservar" ${disabled} onclick="openReserva('${escJs(c.id)}')">Agendar</button>`
          }
        </div>
      </div>`;
  }).join('');
