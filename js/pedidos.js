...
function pedidoCardHTML(p, ofertas, vista, miOferta = null) {
  ...
  if (vista === 'cliente' && !['cancelado','pendiente_revision','pendiente_acuerdo','rechazado','finalizado','expirado'].includes(p.estado)) {
    ...
    // El chat se habilita únicamente cuando se concreta el viaje (en la reservación),
    // no durante la negociación de la oferta.
    acciones = `
...
const NP_OPCIONES = {
  camion: {
    ...
    opciones: [
      ...
      { value: 'Camioneta 1.5 ton caja seca',     label: 'Camioneta 1.5 ton — Caja seca' },
      { value: 'Camioneta 1.5 ton plataforma',    label: 'Camioneta 1.5 ton — Plataforma' },
      { value: 'Camioneta 3.5 ton caja seca',     label: 'Camioneta 3.5 ton — Caja seca' },
      { value: 'Camioneta 3.5 ton plataforma',    label: 'Camioneta 3.5 ton — Plataforma' },
      { value: 'Rabón',                           label: 'Rabón' },
      { value: 'Torton',                          label: 'Torton' },
      { value: 'Torton caja seca',                label: 'Torton — Caja seca' },
      { value: 'Torton plataforma',               label: 'Torton — Plataforma' },
      { value: 'Sencillo porta contenedor 40/20', label: 'Sencillo — Porta contenedor 40/20' },
      { value: 'Sencillo plataforma',             label: 'Sencillo — Plataforma' },
      { value: 'Full',                            label: 'Full' },
      { value: 'Full porta contenedor 40/20',     label: 'Full — Porta contenedor 40/20' },
      { value: 'Full plataforma',                 label: 'Full — Plataforma' },
      { value: 'Plataforma',                      label: 'Plataforma' },
      { value: 'Plataforma de 3 ejes (sobrepeso)','label': 'Plataforma de 3 ejes (sobrepeso)' },
      { value: 'Lowboy',                          label: 'Lowboy' },
      { value: 'Cama baja',                       label: 'Cama baja' },
      { value: 'HAZMAT',                          label: 'Unidad con permiso HAZMAT' },
    ],
  },
  custodio: {
...
function ofertaItemHTML(o) {
  ...
  // El chat se abre al concretar el viaje (reservación), no durante la oferta.
  let acciones = '';
